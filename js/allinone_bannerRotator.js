(function($) {
		...
		function animate_texts(current_obj,allinone_bannerRotator_the,bannerControls) {
			...
			//$(current_obj.currentImg.attr('data-text-id')).css("opacity","1");
			$(current_obj.currentImg.attr('data-text-id')).css("display","block");
			var texts = $(current_obj.currentImg.attr('data-text-id')).children();
			$(current_obj.currentImg.attr('data-text-id')).css('width',allinone_bannerRotator_the.width()+'px');
			$(current_obj.currentImg.attr('data-text-id')).css('left',bannerControls.css('left'));//alert (allinone_bannerRotator_the.width());
	...
	$.fn.allinone_bannerRotator = function(options) {
		...
		return this.each(function() {
			...
			var bannerControls = $('<div class="bannerControls">   <div class="leftNav"></div>   <div class="rightNav"></div>      </div>');
			...
			if (options.enableTouchScreen) {
				...
				//$('#bannerRotatorParent_'+randomNo).css('overflow','hidden');
				//$('#bannerRotatorParent_'+randomNo).css('border','1px solid #ff0000');
